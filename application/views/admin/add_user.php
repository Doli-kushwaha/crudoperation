...
<div id="container">
    <h1>Add User</h1>
    <form method="post" action="<?php echo base_url()?>admin/add_users" enctype="multipart/form-data">
<div class="m-4">

    <div class="row mb-3">
        <label class="col-sm-2 col-form-label col-form-label-lg">User Name</label>
        <div class="col-sm-10">
